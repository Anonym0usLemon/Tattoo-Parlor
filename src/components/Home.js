    ...
    return (
        <>
            ...
            <section className="excellent-headline-section padding-inline">
                <picture>
                    <source media="(min-width:500px" srcset="./Tattoo-Parlor---Frontend/images/Home/excellent-headline-top-1500px.png"/>
                    <img className="exl-section-background" src="./Tattoo-Parlor---Frontend/images/Home/excellent-headline-top.png" alt=""/>
                </picture>
                ...
                <div className="exl-content">
                    <div className="exl-btns">
                        <Link className="exl-btn1" to="/TattooArtists">
                            <picture>
                                <source media="(max-width:640px)" srcset="./Tattoo-Parlor---Frontend/images/Home/our-artists.jpg" />
                                <img className="ServicesImg" src="./Tattoo-Parlor---Frontend/images/Home/our-artists-desktop.png" alt=""/>
                            </picture>
                        ...
                        <Link className="exl-btn2" to="/Piercings">
                            <picture>
                                <source media="(max-width:640px)" srcset="./Tattoo-Parlor---Frontend/images/Home/piercings.jpg" />
                                <img className="ServicesImg" src="./Tattoo-Parlor---Frontend/images/Home/piercings-desktop.png" alt=""/>
                            </picture>
                            <span>PIERCINGS</span>
                            {/* Get an image of an arrow and put it here! */}
                        </Link>
                        ...
                        <Link className="exl-btn3" to="/TattooRemoval">
                            <picture>
                                <source media="(max-width:640px)" srcset="./Tattoo-Parlor---Frontend/images/Home/tattoo-removal.jpg" />
                                <img className="ServicesImg" src="./Tattoo-Parlor---Frontend/images/Home/tattoo-removal-desktop.png" alt=""/>
                            </picture>
                            <span>OUR ARTISTS</span>
                            {/* Get an image of an arrow and put it here! */}
                        </Link>
                    ...
                    <div class="exl-text">				
                        ...
                        <h2>STAYING RAD SINCE 1996<br /> 
                            <span className="exl-headline-span"> 
                                <img className="exl-text-left" src="./Tattoo-Parlor---Frontend/Content/images/Home/exl-headline-left.png" alt="" /> 
                                <span className="exl-headline-p">EXCELLENT HEADLINE</span> 
                                <img className="exl-text-right" src="./Tattoo-Parlor---Frontend/Content/images/Home/exl-headline-right.png" alt="" /> 
                            </span>
                        </h2>
            ...
            <section className="our-work-section padding-inline">
                ...
                <div className="our-work-gallery">
                    <div className="gallery-images">
                        <img src="./Tattoo-Parlor---Frontend/images/Home/gallery1.jpg" alt=""/>
                    </div>
                    <div className="gallery-images">
                        <img src="./Tattoo-Parlor---Frontend/images/Home/gallery2.jpg" alt=""/>
                    </div>
                    <div className="gallery-images">
                        <img src="./Tattoo-Parlor---Frontend/images/Home/gallery3.jpg" alt=""/>
                    </div>
                    <div className="gallery-images">
                        <img src="./Tattoo-Parlor---Frontend/images/Home/gallery4.jpg" alt=""/>
                    </div>
                </div>
            </section>
